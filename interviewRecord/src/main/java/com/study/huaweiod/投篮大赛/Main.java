package com.study.huaweiod.投篮大赛;
...
public class Main {
    /**
     * 题目描述
     * 你现在是一场采用特殊赛制投篮大赛的记录员。这场比赛由若干回合组成，过去几回合的得分可能会影响以后几回合的得分。 比赛开始时，记录是空白的。 你会得到一个记录操作的字符串列表 ops，其中ops[i]是你需要记录的第i项操作，ops遵循下述规则：
     *
     * 整数x - 表示本回合新获得分数x
     ...
     * 27
     * 说明
     * “5”-记录加5，记录现在是[5] “-2”-记录加-2，记录现在是[5,-2]
     *
     * “4”-记录加4，记录现在是[5,-2,4]
     *
