...
public class ImgUtils {
     ...
     * @param bb     是否补白
     */
    public final static void scale(String url, String result, int height, int width, boolean bb) {
        try {
            double ratio = 0.0; // 缩放比例
//            File f = new File(srcImageFile);
//            BufferedImage bi = ImageIO.read(f);

            //        File input = new File("original_image.png");
//        BufferedImage originalImage = ImageIO.read(input);

//            String url = "https://tai-mini-pro-icon-1251316161.cos.ap-beijing.myqcloud.com/wxapkiconlvji_logo.png";
